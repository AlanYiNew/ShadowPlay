...
=======
	struct Z_CompiledInDeferFile_FID_GameDemo_5_0_Plugins_SpinePlugin_Source_SpinePlugin_Public_SpineAtlasAsset_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDemo_5_0_Plugins_SpinePlugin_Source_SpinePlugin_Public_SpineAtlasAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USpineAtlasAsset, USpineAtlasAsset::StaticClass, TEXT("USpineAtlasAsset"), &Z_Registration_Info_UClass_USpineAtlasAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USpineAtlasAsset), 2934299518U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDemo_5_0_Plugins_SpinePlugin_Source_SpinePlugin_Public_SpineAtlasAsset_h_1484109830(TEXT("/Script/SpinePlugin"),
		Z_CompiledInDeferFile_FID_GameDemo_5_0_Plugins_SpinePlugin_Source_SpinePlugin_Public_SpineAtlasAsset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GameDemo_5_0_Plugins_SpinePlugin_Source_SpinePlugin_Public_SpineAtlasAsset_h_Statics::ClassInfo),
